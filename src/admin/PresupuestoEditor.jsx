            ...
            {presupuesto.items.map((item, idx) => (
              <div key={item.id} className="grid grid-cols-12 gap-2">
                <input
                  ...
                  className="focus-ring col-span-12 rounded-lg border border-white/15 bg-white/[0.04] backdrop-blur-xl focus:border-[#c9a227]/60 focus:ring-2 focus:ring-[#c9a227]/10 px-3 py-2 text-sm text-[#f2f0ea] sm:col-span-5"
                />
                <input
                ...
                <select
                  ...
                  className="focus-ring col-span-4 rounded-lg border border-white/15 bg-white/[0.04] backdrop-blur-xl focus:border-[#c9a227]/60 focus:ring-2 focus:ring-[#c9a227]/10 px-2 py-2 text-sm text-[#f2f0eab3] sm:col-span-2"
                >
                  {UNIDADES.map((u) => (
                    <option key={u.valor} value={u.valor} className="bg-[#141416]">{u.valor}</option>
                  ))}
                </select>
                <input
                  ...
                  className="focus-ring col-span-4 rounded-lg border border-white/15 bg-white/[0.04] backdrop-blur-xl focus:border-[#c9a227]/60 focus:ring-2 focus:ring-[#c9a227]/10 px-3 py-2 text-sm text-[#f2f0ea] sm:col-span-2"
                />
