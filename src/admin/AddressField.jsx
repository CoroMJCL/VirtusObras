  ...
  return (
    <div className="relative">
      <input
        ...
        className="focus-ring w-full rounded-xl border border-[#c7d0da] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.03)] focus:border-[#c9a227] focus:ring-2 focus:ring-[#c9a227]/10 px-4 py-2.5 pr-10 text-sm text-[#1a2233]"
      />
      {apiKey && listo ? (
        ...
        value && (
          <a
            ...
            className="focus-ring absolute right-3 top-1/2 -translate-y-1/2 text-[#94a1b3] hover:text-gold"
          >
