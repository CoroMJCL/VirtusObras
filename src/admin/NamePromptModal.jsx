...
export default function NamePromptModal({ onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 px-6 backdrop-blur-sm">
      <form onSubmit={guardar} className="w-full max-w-sm rounded-2xl border border-white/10 bg-[#141416]/95 p-7 backdrop-blur-2xl shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
        ...
        <input
          ...
          className="focus-ring w-full rounded-xl border border-white/10 bg-white/[0.05] px-4 py-2.5 text-[14px] text-bone placeholder:text-bone/25"
        />
